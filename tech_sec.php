...
$sql = "SELECT * FROM candidate WHERE election_id=105";
...
?>
<h1> TECHNICAL SECREATRY CANDIDATES </h1>
...
<?php   echo '<tr>
         <td>
          <input type="radio" name="techsec" value="techsec">
         </td>
         <td>
          '.$row['user_name'].'
         </td>
...
?>
<input type=button onClick="location.href='welfare_sec.php'" value='Next'>
<div id="bo__dy">
     <div id="bo__dy_p1">
	 </div>
