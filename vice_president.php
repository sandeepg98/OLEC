...
$sql = "SELECT * FROM candidate WHERE election_id=102";
...
<?php   echo '<tr>
         <td>
          <input type="radio" name="vicepresident" value="vicepresident">
         </td>
         <td>
          '.$row['user_name'].'
         </td>
...
?>
<input type=button onClick="location.href='cult_sec.php'" value='Next'>
<div id="bo__dy">
     <div id="bo__dy_p1">
	 </div>
