...
$sql = "SELECT * FROM candidate WHERE election_id=103";
...
?>
<h1> CULTURAL SECRETARY CANDIDATES </h1>
...
<?php   echo '<tr>
         <td>
          <input type="radio" name="cultsec" value="cultsec">
         </td>
         <td>
          '.$row['user_name'].'
         </td>
...
?>
<input type=button onClick="location.href='sports_sec.php'" value='Next'>
<div id="bo__dy">
     <div id="bo__dy_p1">
	 </div>
