...
$sql = "SELECT * FROM candidate WHERE election_id=104";
...
?>
<h1> SPORTS SECRETARY CANDIDATES </h1>
...
<?php   echo '<tr>
         <td>
          <input type="radio" name="sportsec" value="sportsec">
         </td>
         <td>
          '.$row['user_name'].'
         </td>
...
?>
<input type=button onClick="location.href='tech_sec.php'" value='Next'>
<div id="bo__dy">
     <div id="bo__dy_p1">
	 </div>
